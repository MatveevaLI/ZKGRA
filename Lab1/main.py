...
# Initializes dictionaries for direct, reverse, and divided orders of encoding message
def initialize():
    direct_order = {}
    reverse_order = {}
    divide_order = {}
...
letter_numbers_direct, letter_numbers_reverse, letter_numbers_divide = initialize()
...
def exec_with_time(input_message, function, alphabet, function_message):
    ...
    print("[{:.3f}ms] {} message:\t\t{} {}".format(duration(start_time, end_time) * 1000, function_message, input_message, output))
